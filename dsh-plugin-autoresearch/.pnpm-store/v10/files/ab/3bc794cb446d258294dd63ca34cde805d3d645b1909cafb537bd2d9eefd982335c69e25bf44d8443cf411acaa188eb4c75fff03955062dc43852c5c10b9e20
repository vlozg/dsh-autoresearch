...
export interface CustomHMRIconLoader {
   ...
   */
  resolveModuleIconName: (normalizedSVGPath: string) => string | undefined;
  /**
...
export type IconifyLoaderOptions = {
   ...
   */
  customCollections?: Record<string, (() => Awaitable<IconifyJSON>) | undefined | CustomCollectionIconLoader>;
  /**
   * Icon customizer
   */
