...
Disallow escaped newlines in string literals.

Remove incorrectly supported `0o` octal literals.

Correct the precedence of the `%` operator.

Fix the relative precedence of the `|` and `^` operators.
