...
import { getRootOwnerDocument, getDOMShadowRoots, isDOMShadowRoot, getParentElement, defineExtension, $getEditor, shallowMergeConfig, safeCast, $isRangeSelection, tokenizeRawText, $getSelection, $createTabNode, $getRoot, $isNodeSelection, $getSlotFrame, $isElementNode, $parseSerializedNode, SELECTION_INSERT_CLIPBOARD_NODES_COMMAND, getDOMSelection, COPY_COMMAND, COMMAND_PRIORITY_CRITICAL, $isTextNode, $getSlotNames, $getSlot, $splitAtPointCaretNext, $setSelectionFromCaretRange, $getCollapsedCaretRange, $caretFromPoint, $isTextPointCaret, $getCaretRange, $getChildCaret, getDOMSelectionPoints, isSelectionWithinEditor, $getNearestNodeFromDOMNode, $getTextPointCaret, $getChildCaretAtIndex, $getCaretRangeInDirection, $caretRangeFromSelection, $comparePointCaretNext, findAllLexicalElementsDeep, getEditorPropertyFromDOMNode, isLexicalEditor, isHTMLElement } from 'lexical';
...
const ClipboardDOMImportExtension = /* @__PURE__ */defineExtension({
  dependencies: [CoreImportExtension, /* @__PURE__ */configExtension(ClipboardImportExtension, {
    $importMimeType: {
