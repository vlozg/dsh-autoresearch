...
import { $getSelection, $isRangeSelection, $isTextNode, defineExtension, safeCast, getEditorPropertyFromDOMNode, getActiveElementDeep, isLexicalEditor } from 'lexical';
