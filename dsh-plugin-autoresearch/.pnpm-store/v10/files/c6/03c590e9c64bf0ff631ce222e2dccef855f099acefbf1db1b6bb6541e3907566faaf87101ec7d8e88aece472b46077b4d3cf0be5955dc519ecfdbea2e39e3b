 ...
 */
const HistoryExtension = /* @__PURE__ */lexical.defineExtension({
  build: (editor, {
    delay,
 ...
 */
const SharedHistoryExtension = /* @__PURE__ */lexical.defineExtension({
  build: (editor, {
    disabled,
    parentEditor
  }) => extension.namedSignals({
  ...
  dependencies: [/* @__PURE__ */lexical.configExtension(HistoryExtension, {
    disabled: true
  })],
